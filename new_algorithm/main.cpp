...
int main(int argc, char *argv[])
{
    ...
    std::cout << "KMB 2-approximation: " << kmb_result.blocked_edges.size() << " blocked edges, blocked weight: "
              << kmb_result.blockedWeight() << ", unblocked weight: "
              << kmb_result.total_weight << " (runtime: " << kmb_result.runtime << " ms)" << std::endl;
    std::cout << "Exact brute-force: " << exact_result.blocked_edges.size() << " blocked edges, blocked weight: "
    ...
    std::cout << "Approximation ratio (blocked weight): " << weight_ratio << std::endl;
